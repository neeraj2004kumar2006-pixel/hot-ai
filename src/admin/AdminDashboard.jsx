  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: '800', color: 'var(--text)' }}>Admin Dashboard</h1>
      ...
      {/* Demo Banner */}
      <div style={{ background: 'rgba(254,179,0,0.1)', border: '1px solid var(--primary)', borderRadius: 'var(--card-radius)', padding: '12px 16px', marginBottom: '28px', color: 'var(--text-secondary)', fontSize: '0.82rem', display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      {/* Recent Posts */}
      <h2 style={{ fontSize: '1.1rem', fontWeight: '700', color: 'var(--text)', marginBottom: '16px' }}>Recent Posts</h2>
            ...
            {recentPosts.map((r, i) => {
              ...
              return (
                <tr key={i} style={{ borderBottom: '1px solid var(--border)' }}>
                  <td style={{ padding: '12px 16px', color: 'var(--text)', fontWeight: '600' }}>{title}</td>
